...
public class ModifyCashView implements View {
    ...
    public void setUpCashTable(){
        ...
        TableColumn modifyBTNColumn = new TableColumn("Action");
        modifyBTNColumn.setCellValueFactory(new PropertyValueFactory<>(""));
        cashTable.getColumns().addAll(nameColumn,amountColumn,modifyBTNColumn);
        ...
        modifyBTNColumn.setCellValueFactory(cellFactory);
    }
